...
<SpotlightCard className="custom-spotlight-card" spotlightColor="rgba(0, 229, 255, 0.2)">
            <Box sx={{ width:"15rem", height:"12rem", display:'flex', alignItems:'center', flexDirection:'column', cursor:'pointer' }} >
                <Box>
                    <Box component='img' src={robotic} sx={{ width:'4rem' }} />
                </Box>
                <Divider variant="middle" sx={{ width:"100%" , backgroundColor:"white", mt:1 }} />
                <Typography sx={{ fontFamily:"roboto", fontSize:'1.2rem', mt:2 }} >Automation Development</Typography>

                <Typography sx={{ fontSize:'0.8rem', fontWeight:300, color:'gray', mt:1, fontFamily:'poppins' }} >Automation services transform routine tasks into seamless processes, empowering businesses to focus on innovation,</Typography>
